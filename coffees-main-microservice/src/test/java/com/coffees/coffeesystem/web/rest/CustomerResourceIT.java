...
import com.coffees.coffeesystem.domain.Customer;
import com.coffees.coffeesystem.repository.CustomerRepository;
...
class CustomerResourceIT {
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer().customerName(DEFAULT_CUSTOMER_NAME).customerPhone(DEFAULT_CUSTOMER_PHONE);
        return customer;
    }
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer().customerName(UPDATED_CUSTOMER_NAME).customerPhone(UPDATED_CUSTOMER_PHONE);
        return customer;
    }
    ...
    void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getCustomerPhone()).isEqualTo(DEFAULT_CUSTOMER_PHONE);
    }
    ...
    void putNewCustomer() throws Exception {
        ...
        updatedCustomer.customerName(UPDATED_CUSTOMER_NAME).customerPhone(UPDATED_CUSTOMER_PHONE);
        ...
        assertThat(testCustomer.getCustomerPhone()).isEqualTo(UPDATED_CUSTOMER_PHONE);
    }
    ...
    void fullUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.customerName(UPDATED_CUSTOMER_NAME).customerPhone(UPDATED_CUSTOMER_PHONE);
